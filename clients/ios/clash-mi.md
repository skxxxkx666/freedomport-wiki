...
::: info 此类应用在国区 App Store 未上架，需要美区等外区 Apple ID 下载。登录外区 ID 下载后可切回常用账号，应用保留可用。 :::
...
![在会员中心复制订阅链接或一键导入](../../.gitbook/assets/clash-mi-01.png)

### 步骤二：新建配置

打开 Clash Mi，在主界面的「我的配置」一栏，点击右侧的**加号（+）**。

![点击我的配置加号](../../.gitbook/assets/clash-mi-02.png)

### 步骤三：选择添加配置链接

在底部弹出的菜单中，选择**添加配置链接**。

![选择添加配置链接](../../.gitbook/assets/clash-mi-03.png)
...
![填写订阅链接和备注并保存](../../.gitbook/assets/clash-mi-04.png)
...
![点击连接开关开始连接](../../.gitbook/assets/clash-mi-05.png)
...
**Q: 提示订阅无效？** A: 检查链接是否完整；用浏览器打开链接测试是否有返回内容。

**Q: 显示已连接但无法上网？** A: 切换节点测试；关闭再重新开启连接开关；检查系统时间与时区是否准确。

**Q: 节点全部不可用？** A: 更新订阅后重测；确认套餐在有效期内、流量未用完。
