...
![在会员中心复制订阅链接](../../.gitbook/assets/clash-meta-for-Android-01.png)

### 步骤二：进入配置管理

打开 Clash Meta for Android，此时顶部显示「已停止」。点击下方的**配置**卡片，进入配置管理页面。

![点击配置卡片](../../.gitbook/assets/clash-meta-for-Android-02.png)

### 步骤三：新建配置

在配置列表页，点击右上角的**加号（+）**，开始新建一个配置。

![点击右上角加号新建配置](../../.gitbook/assets/clash-meta-for-Android-03.png)

### 步骤四：选择从 URL 导入

在「创建配置」页面，选择 **URL（从 URL 导入）**。

![选择从 URL 导入](../../.gitbook/assets/clash-meta-for-Android-04.png)
...
![填写名称、订阅地址、自动更新并保存](../../.gitbook/assets/clash-meta-for-Android-05.png)
...
![点击启动开始连接](../../.gitbook/assets/clash-meta-for-Android-06.png)
...
**Q: 导入订阅后没有节点？** A: 先手动更新配置；确认订阅链接可访问；确认套餐在有效期内、流量未用完。

**Q: 已连接但无法访问网站？** A: 切换节点重试；检查是否已授予 VPN 权限；确认代理模式为规则或全局。

**Q: 节点延迟都很高？** A: 先更换网络环境（如切换 Wi-Fi / 蜂窝网络），再切换到距离更近的节点组。
