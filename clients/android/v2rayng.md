...
![会员中心复制订阅链接或一键导入 v2rayNG](../../.gitbook/assets/v2rayng-02.png)
...
**Q: 导入报错或订阅为空？** A: 链接可能失效或不完整；先在浏览器测试链接是否有返回，再重新导入。

**Q: 连上后打不开网页？** A: 切换节点重试，检查 VPN 权限是否仍在，确认本地时间准确。

**Q: 节点全部超时？** A: 先切换网络（Wi-Fi / 蜂窝），再更新订阅；如仍异常，见[常见问题 FAQ](../../guide/faq.md)。
